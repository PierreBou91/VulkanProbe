...
AppResult redo(App *app)
{
    ...
    // Then we need to get the required extensions from GLFW and from the user, this is
    ...
    {
        printf("========================================\n");
        printf("Required extensions for the Vulkan instance:\n");
        printf("\tFrom GLFW:\n");
    ...
    {
        printf("========================================\n");
        printf("Concatenated required extensions for the Vulkan instance:\n");
